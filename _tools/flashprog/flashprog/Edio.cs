...
namespace flashprog
{
    ...
    class Edio
    {
        ...
        public const int ADDR_PRG = 0x000000;
        public const int ADDR_CHR = 0x400000;
        public const int ADDR_SRM = 0x800000;
        public const int ADDR_CFG = 0xC00000;
        public const int ADDR_SSR = 0xC00100;
        public const int ADDR_FIFO = 0xC10000;
        ...
        const byte CMD_GET_UID = 0xF2;
        const byte CMD_GET_SIGNA = 0xF3;
        ...
        public void fpgInit(byte[] data)
        {
            ...
            //rx8();//wait for reset end
            //txData(data, 0, data.Length);
